...
# Functions
# ==============================
def search_youtube(keyword, max_results=10, video_type="Video"):
    """Search videos for a given keyword and type"""
    try:
        request_params = {
            "q": keyword,
            "part": "id,snippet",
        ...
        if video_type == "Shorts":
            # Shorts typically less than 60 sec, YouTube API categorizes short as 'short'
...
def niche_research(keywords, max_results=10, max_subs=1000, min_views=10000, video_type="Video"):
    """Run niche research and return filtered results"""
    all_results = []

    for keyword in keywords:
        search_response = search_youtube(keyword, max_results=max_results, video_type=video_type)
